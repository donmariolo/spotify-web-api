...
public String toString() {
	return "Album [albumType=" + albumType + ", artists=" + artists
			+ ", availableMarkets=" + availableMarkets + ", copyrights="
			+ copyrights + ", externalIds=" + externalIds + ", externalUrls="
			+ externalUrls + ", genres=" + genres + ", href=" + href + ", id="
			+ id + ", images=" + images + ", name=" + name + ", popularity="
			+ popularity + ", releaseDate=" + releaseDate
			+ ", releaseDatePrecision=" + releaseDatePrecision + ", tracks="
