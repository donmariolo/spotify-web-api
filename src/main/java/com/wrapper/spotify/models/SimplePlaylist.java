...
public String toString() {
	return "SimplePlaylist [collaborative=" + collaborative + ", externalUrls="
			+ externalUrls + ", href=" + href + ", id=" + id + ", images="
			+ images + ", owner=" + owner + ", name=" + name
			+ ", publicAccess=" + publicAccess + ", tracks=" + tracks
			+ ", type=" + type + ", uri=" + uri + "]";
}
}
